...
### BUG-1 — Resolución inteligente de duplicados (pendiente)

| # | Qué | Detalle |
|---|-----|---------|
| B1-4 | **Resolver duplicados conservando logros RA** | Cuando hay dos copias del mismo juego (ej. versiones distintas), seleccionar automáticamente la que tiene logros activos en RetroAchievements como "copia principal" y borrar el resto. |
