...
> Last updated: 2026-07-04 (ONB-8: podado — secciones completadas → `Tareas/diario/archivo/archivo.md`)
...
> **Orden recomendado:** ~~ONB-1~~ → ~~ONB-2~~ → ~~ONB-4~~ → ~~ONB-3~~ → ONB-5+ONB-6
> (se escriben juntos) → ~~ONB-7~~ → ~~ONB-8~~ → ONB-9. Detalle: `Tareas/Roadmap-Onboarding.md`.
