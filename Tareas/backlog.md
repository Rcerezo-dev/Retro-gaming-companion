...
| B3 | Library comparator PC vs Android — diff screen + `POST /api/sync-roms` + conflict policy | | In progress: B3-1 ✅ (backend diff enhancement), B3-2 through B3-5 pending |
