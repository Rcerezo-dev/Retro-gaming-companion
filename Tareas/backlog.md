...
2026-09-02** (rama `fix/ra-hash-psx-subdir-boot`, sin PR todavía): `_find_root_file` reescrito para
...
`test_compute_psx_ra_hash_boot_in_subdirectory`. 1132/1132 tests en verde, `ruff` limpio | `src/rom_manager/retroachievements/ra_hash_psx.py:106-178` | ✅ arreglado, commit local sin PR |
