...
🔵 **Sigue pendiente, sin pedir todavía**: (4) decidir qué hacer con las carpetas ya vaciadas (`backup/`, `Classic Game/`, `Featured Games/`, `GB official game ROM complete works/A-Z/` — tras (2) y (3) probablemente solo quedan los 166 sin duplicado exacto + carpetas vacías, borrado de las vacías seguro tras confirmar) |
