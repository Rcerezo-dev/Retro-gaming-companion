...
2026-09-02** (rama `fix/ra-hash-psx-subdir-boot`, [PR #286](https://github.com/Rcerezo-dev/Retro-gaming-companion/pull/286)): `_find_root_file` reescrito para
...
`test_compute_psx_ra_hash_boot_in_subdirectory`. 1132/1132 tests en verde, `ruff` limpio. Recálculo en frío contra la biblioteca PSX real (1.175 ROMs): 324 pasan a tener hash calculable y coincidente con RA | `src/rom_manager/retroachievements/ra_hash_psx.py:106-178` | ✅ arreglado, [PR #286](https://github.com/Rcerezo-dev/Retro-gaming-companion/pull/286) abierto |
...
coincidencia pura de tamaño (1.048.576 bytes, tamaño muy común) y de parte del nombre. No se ha
investigado todavía si es un caso aislado o un patrón más amplio del matcher de catálogo.

| ID | Task | Archivo(s) | Estado |
|----|------|-----------|--------|
| CATALOG-MATCH-BUG-1 | Investigar por qué `deer hunter.bin` (Mega Drive) matcheó contra el catálogo de Game Boy Color — el matcher no debería cruzar plataformas nunca, sea cual sea el criterio de similitud de nombre/tamaño usado | `catalog/` (matcher, sin localizar la función exacta todavía) | 🔴 pendiente, investigar alcance |
